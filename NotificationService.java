...
public final class NotificationService {
    ...
    public boolean broadcast(String message, Priority priority) {
        ...
        if (message==null|| message.isEmpty()) throw new IllegalArgumentException("message ห้ามเป็นnullว่าง"); 
        if (priority==null)throw new IllegalArgumentException("priorityห้าม null"); 
